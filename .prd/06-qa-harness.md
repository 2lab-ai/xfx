...
| 16 | Slash menu | 2 | `/` opens the picker; ranking is exact-prefix > alias > substring; Esc dismisses and the dismissal survives further typing until the trigger kind changes; Tab completes |
